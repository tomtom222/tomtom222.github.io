...
!function (t, e) {
  ...
  'use strict'; function i(t, e) {
    ...
    function t(t) {
      ...
      TRANSITION_END: 'bsTransitionEnd', getUID: function (t) { for (; t += ~~(1e6 * Math.random()), document.getElementById(t);); return t }, getSelectorFromElement: function (t) {
        ...
        e && '#' !== e || (e = t.getAttribute('href') || ''); try { return document.querySelector(e) ? e : null } catch (t) { return null }
  ...
  }), m.fn[p] = k._jQueryInterface, m.fn[p].Constructor = k, m.fn[p].noConflict = function () { return m.fn[p] = C, k._jQueryInterface }, k), Qn = (j = 'carousel', L = '.' + (H = 'bs.carousel'), R = '.data-api', x = (P = e).fn[j], W = { interval: 5e3, keyboard: !0, slide: !1, pause: 'hover', wrap: !0 }, U = { interval: '(number|boolean)', keyboard: 'boolean', slide: '(boolean|string)', pause: '(string|boolean)', wrap: 'boolean' }, q = 'next', F = 'prev', K = 'left', M = 'right', Q = { SLIDE: 'slide' + L, SLID: 'slid' + L, KEYDOWN: 'keydown' + L, MOUSEENTER: 'mouseenter' + L, MOUSELEAVE: 'mouseleave' + L, TOUCHEND: 'touchend' + L, LOAD_DATA_API: 'load' + L + R, CLICK_DATA_API: 'click' + L + R }, B = 'carousel', V = 'active', Y = 'slide', z = 'carousel-item-right', J = 'carousel-item-left', Z = 'carousel-item-next', G = 'carousel-item-prev', $ = '.active', X = '.active.carousel-item', tt = '.carousel-item', et = '.carousel-item-next, .carousel-item-prev', nt = '.carousel-indicators', it = '[data-slide], [data-slide-to]', rt = '[data-ride="carousel"]', ot = function () {
    function o(t, e) { this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(e), this._element = P(t)[0], this._indicatorsElement = this._element.querySelector(nt), this._addEventListeners() } var t = o.prototype
    return t.next = function () { this._isSliding || this._slide(q) }, t.nextWhenVisible = function () { !document.hidden && P(this._element).is(':visible') && 'hidden' !== P(this._element).css('visibility') && this.next() }, t.prev = function () { this._isSliding || this._slide(F) }, t.pause = function (t) { t || (this._isPaused = !0), this._element.querySelector(et) && (Fn.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null }, t.cycle = function (t) { t || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config.interval && !this._isPaused && (this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval)) }, t.to = function (t) {
      var e = this
      this._activeElement = this._element.querySelector(X); var n = this._getItemIndex(this._activeElement)
      ...
      this._isSliding = !0, h && this.pause(), this._setActiveIndicatorElement(l); var u = P.Event(Q.SLID, { relatedTarget: l, direction: r, from: a, to: c })
        if (P(this._element).hasClass(Y)) {
          P(l).addClass(i), Fn.reflow(l), P(s).addClass(n), P(l).addClass(n); var f = Fn.getTransitionDurationFromElement(s)
      ...
      return this.each(function () {
        ...
        'object' == typeof i && (e = l({}, e, i)); var n = 'string' == typeof i ? i : e.slide
        if (t || (t = new o(this, e), P(this).data(H, t)), 'number' == typeof i) t.to(i)
        else if ('string' == typeof n) { if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"'); t[n]() } else e.interval && (t.pause(), t.cycle())
      })
    ...
    return t.toggle = function () {
      ...
      if (!this._isTransitioning && !st(this._element).hasClass(gt) && (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(Et)).filter(function (t) { return t.getAttribute('data-parent') === n._config.parent })).length && (t = null), !(t && (e = st(t).not(this._selector).data(lt)) && e._isTransitioning))) {
        ...
        if (st(this._element).trigger(i), !i.isDefaultPrevented()) {
          ...
          st(this._element).removeClass(_t).addClass(mt), this._element.style[r] = 0, this._triggerArray.length && st(this._triggerArray).removeClass(pt).attr('aria-expanded', !0), this.setTransitioning(!0); var o = 'scroll' + (r[0].toUpperCase() + r.slice(1)), s = Fn.getTransitionDurationFromElement(this._element)
      ...
      if (!this._isTransitioning && st(this._element).hasClass(gt)) {
        ...
        if (st(this._element).trigger(e), !e.isDefaultPrevented()) {
          ...
          this._element.style[n] = this._element.getBoundingClientRect()[n] + 'px', Fn.reflow(this._element), st(this._element).addClass(mt).removeClass(_t).removeClass(gt); var i = this._triggerArray.length
          if (0 < i) for (var r = 0; r < i; r++) {
            var o = this._triggerArray[r], s = Fn.getSelectorFromElement(o)
            if (null !== s) st([].slice.call(document.querySelectorAll(s))).hasClass(gt) || st(o).addClass(pt).attr('aria-expanded', !1)
          } this.setTransitioning(!0); this._element.style[n] = ''; var a = Fn.getTransitionDurationFromElement(this._element)
      ...
      var n = this, t = null
      Fn.isElement(this._config.parent) ? (t = this._config.parent, 'undefined' != typeof this._config.parent.jquery && (t = this._config.parent[0])) : t = document.querySelector(this._config.parent); var e = '[data-toggle="collapse"][data-parent="' + this._config.parent + '"]', i = [].slice.call(t.querySelectorAll(e))
  ...
  'A' === t.currentTarget.tagName && t.preventDefault(); var n = st(this), e = Fn.getSelectorFromElement(this), i = [].slice.call(document.querySelectorAll(e))
    st(i).each(function () {
    ...
    return t.toggle = function () {
      if (!this._element.disabled && !bt(this._element).hasClass(kt)) {
        ...
        if (c._clearMenus(), !e) {
          ...
          if (bt(t).trigger(i), !i.isDefaultPrevented()) {
            if (!this._inNavbar) {
              if ('undefined' == typeof h) throw new TypeError('Bootstrap dropdown require Popper.js (https://popper.js.org)'); var r = this._element
      ...
      return this.each(function () {
        ...
        if (t || (t = new c(this, 'object' == typeof e ? e : null), bt(this).data(It, t)), 'string' == typeof e) { if ('undefined' == typeof t[e]) throw new TypeError('No method named "' + e + '"'); t[e]() }
      })
    ...
    function r(t, e) { this._config = this._getConfig(e), this._element = t, this._dialog = t.querySelector(ue), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._scrollbarWidth = 0 } var t = r.prototype
    return t.toggle = function (t) { return this._isShown ? this.hide() : this.show(t) }, t.show = function (t) {
      ...
      if (this._isShown && this._config.backdrop) {
        ...
        }), n && Fn.reflow(this._backdrop), $t(this._backdrop).addClass(he), !t) return; if (!n) return void t(); var i = Fn.getTransitionDurationFromElement(this._backdrop)
        $t(this._backdrop).one(Fn.TRANSITION_END, t).emulateTransitionEnd(i)
      } else if (!this._isShown && this._backdrop) {
        $t(this._backdrop).removeClass(he); var r = function () { e._removeBackdrop(), t && t() }
      ...
      t.className = se, document.body.appendChild(t); var e = t.getBoundingClientRect().width - t.clientWidth
    ...
    'A' !== this.tagName && 'AREA' !== this.tagName || t.preventDefault(); var o = $t(e).one(oe.SHOW, function (t) { t.isDefaultPrevented() || o.one(oe.HIDDEN, function () { $t(n).is(':visible') && n.focus() }) })
    ...
    function i(t, e) { if ('undefined' == typeof h) throw new TypeError('Bootstrap tooltips require Popper.js (https://popper.js.org)'); this._isEnabled = !0, this._timeout = 0, this._hoverState = '', this._activeTrigger = {}, this._popper = null, this.element = t, this.config = this._getConfig(e), this.tip = null, this._setListeners() } var t = i.prototype
    return t.enable = function () { this._isEnabled = !0 }, t.disable = function () { this._isEnabled = !1 }, t.toggleEnabled = function () { this._isEnabled = !this._isEnabled }, t.toggle = function (t) {
      ...
      } else { if (pe(this.getTipElement()).hasClass(ke)) return void this._leave(null, this); this._enter(null, this) }
      ...
      var e = this
      if ('none' === pe(this.element).css('display')) throw new Error('Please use show on visible elements'); var t = pe.Event(this.constructor.Event.SHOW)
      if (this.isWithContent() && this._isEnabled) {
        pe(this.element).trigger(t); var n = pe.contains(this.element.ownerDocument.documentElement, this.element)
        if (t.isDefaultPrevented() || !n) return; var i = this.getTipElement(), r = Fn.getUID(this.constructor.NAME)
        i.setAttribute('id', r), this.element.setAttribute('aria-describedby', r), this.setContent(), this.config.animation && pe(i).addClass(Oe); var o = 'function' == typeof this.config.placement ? this.config.placement.call(this, i, this.element) : this.config.placement, s = this._getAttachment(o)
        this.addAttachmentClass(s); var a = !1 === this.config.container ? document.body : pe(document).find(this.config.container)
        pe(i).data(this.constructor.DATA_KEY, this), pe.contains(this.element.ownerDocument.documentElement, this.tip) || pe(i).appendTo(a), pe(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new h(this.element, i, { placement: s, modifiers: { offset: { offset: this.config.offset }, flip: { behavior: this.config.fallbackPlacement }, arrow: { element: je }, preventOverflow: { boundariesElement: this.config.boundary } }, onCreate: function (t) { t.originalPlacement !== t.placement && e._handlePopperPlacementChange(t) }, onUpdate: function (t) { e._handlePopperPlacementChange(t) } }), pe(i).addClass(ke), 'ontouchstart' in document.documentElement && pe(document.body).children().on('mouseover', null, pe.noop); var l = function () {
    ...
    }, t._getAttachment = function (t) { return Ie[t.toUpperCase()] }, t._setListeners = function () {
      var i = this
      ...
      return this.each(function () {
        ...
        if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), pe(this).data(ye, t)), 'string' == typeof n)) { if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"'); t[n]() }
      })
    ...
    var e, n
    function i() { return t.apply(this, arguments) || this } n = t, (e = i).prototype = Object.create(n.prototype), (e.prototype.constructor = e).__proto__ = n; var r = i.prototype
    return r.isWithContent = function () { return this.getTitle() || this._getContent() }, r.addAttachmentClass = function (t) { Ue(this.getTipElement()).addClass(Qe + '-' + t) }, r.getTipElement = function () { return this.tip = this.tip || Ue(this.config.template)[0], this.tip }, r.setContent = function () {
      ...
      this.setElementContent(t.find(Ze), this.getTitle()); var e = this._getContent()
      ...
      return this.each(function () {
        ...
        if ((t || !/destroy|hide/.test(n)) && (t || (t = new i(this, e), Ue(this).data(Fe, t)), 'string' == typeof n)) { if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"'); t[n]() }
      })
    ...
    this._activeTarget = e, this._clear(); var t = this._selector.split(',')
      ...
      return this.each(function () {
        ...
        if (t || (t = new n(this, 'object' == typeof e && e), tn(this).data(nn, t)), 'string' == typeof e) { if ('undefined' == typeof t[e]) throw new TypeError('No method named "' + e + '"'); t[e]() }
      })
    ...
    return t.show = function () {
      ...
      if (e) {
        bn(e).removeClass(Pn + ' ' + Nn); var i = bn(e.parentNode).find(Un)[0]
      ...
      return this.each(function () {
        ...
        if (e || (e = new i(this), t.data(Sn, e)), 'string' == typeof n) { if ('undefined' == typeof e[n]) throw new TypeError('No method named "' + n + '"'); e[n]() }
      })
  ...
  !function (t) {
    if ('undefined' == typeof t) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript."); var e = t.fn.jquery.split(' ')[0].split('.')
